        ...
        <div class="container">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="zamboangapeninsula.php">Zamboanga Peninsula</a>
                    <a href="northernmindanao.php">Northern Mindanao</a>
                    <a href="davaoregion.php">Davao Region</a>
                    <a href="soccsksargen.php">SOCCSKSARGEN</a>
                    <a href="caraga.php">Caraga</a>
                    <a href="brmm.php">BARMM (Bangsamoro Autonomous Region in Muslim Mindanao)</a>
                    <!-- Add more regions as needed -->
                    <a class="button" onclick="window.location.href='culture2.php'" style="background-color: #9370DB;">Back</a>
                </div>
