...
<body>
        ...
        <div class="container">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="ilocos.php" onclick="highlightRegion('ilocos')">Region I - Ilocos Region</a>
                    <a href="cagayanvalley.php" onclick="highlightRegion('cagayan')">Region II - Cagayan Valley</a>
                    <a href="centralluzon.php" onclick="highlightRegion('central_luzon')">Region III - Central Luzon</a>
                    <a href="calabarzon.php" onclick="highlightRegion('calabarzon')">Region IV-A - CALABARZON</a>
                    <a href="mimaropa.php" onclick="highlightRegion('mimaropa')">Region IV-B - MIMAROPA</a>
                    <a href="bicol.php" onclick="highlightRegion('bicol')">Region V - Bicol Region</a>
                    <a href="car.php" onclick="highlightRegion('car')">Cordillera Administrative Region (CAR)</a>
                    <a href="ncr.php" onclick="highlightRegion('ncr')">National Capital Region (NCR)</a>
                    <a class="button" onclick="window.location.href='culture2.php'" style="background-color: #329;">Back</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <div id="region-info" style="padding: 20px;"></div>
